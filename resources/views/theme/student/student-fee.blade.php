                        ...
                        <table class="table table-striped table-hover table-bordered align-middle mb-0 text-center">
                            <thead class="table-primary align-middle">
                                <tr>
                                    ...
                                    <th class=" text-dark" style="width: 20%;">Student</th>
                                    <th class=" text-dark" style="width: 15%;">Academic year</th>
                                    <th class=" text-dark" style="width: 15%;"> amount</th>
                                    <th class=" text-dark" style="width: 15%;"> Paid Amount</th>
                                    <th class=" text-dark" style="width: 15%;">Remaining Amount</th>
                                    <th class=" text-dark" style="width: 15%;"> due_date</th>
                                    <th class=" text-dark" style="width: 20%;">Actions</th>
                                </tr>
                            </thead>
                            <tbody>
                                @forelse($students_fee as $index => $fee)
                                <tr>
                                    <td class="fw-bold">{{ $index + 1 }}</td>
                                    <td class="text-capitalize">{{ $fee->student->name }}</td>
                                    <td class="text-break">{{ $fee->academic_year}}</td>
                                    <td>{{ $fee->amount ?? '-' }}</td>
                                    ...
                                    <td>
                                        <div class="d-flex gap-2">
                                            <a href="{{ route('theme.fee.edit', $fee->id) }}"
                                                ...
                                                <i class="bi bi-pencil-square me-1"></i> pay 
                                            </a>
                                        </div>
                                    </td>
                                </tr>
