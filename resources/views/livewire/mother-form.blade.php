...
<div style="display: none" class="row setup-content" id="step-2">
    ...
    <div class="col-xs-12">
        <div class="col-md-12">
            ...
            <div class="form-row">
                <div class="col">
                    <label for="title"> {{ __('keyworld.Name_Mother') }}</label>
                ...
                <div class="col">
                    <label for="title"> {{ __('keyworld.Name_Mother_en') }}</label>
            ...
            <div class="form-row">
                <div class="col-md-3">
                    <label for="title">{{ __('keyworld.Job_Mother') }}</label>
                ...
                <div class="col-md-3">
                    <label for="title">{{ __('keyworld.Job_Mother_en') }}</label>
                ...
                <div class="col">
                    <label for="title">{{ __('keyworld.National_ID_Mother') }}</label>
                ...
                <div class="col">
                    <label for="title">{{ __('keyworld.Passport_ID_Mother') }}</label>
                ...
                <div class="col">
                    <label for="title">{{__('keyworld.Phone_Mother')}}</label>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label for="inputCity">{{__('keyworld.Nationality_Father_id')}}</label>
                ...
                <div class="form-group col">
                    <label for="inputState">{{__('keyworld.Blood_Type_Father_id')}}</label>
                ...
                <div class="form-group col">
                    <label for="inputZip">{{__('keyworld.Religion_Father_id')}}</label>
            ...
            <div class="form-group">
                <label for="exampleFormControlTextarea1">{{__('keyworld.Address_Mother')}}</label>
            ...
            <button class="btn btn-success btn-sm nextBtn btn-lg pull-right" type="button"
                wire:click="secondStepSubmit">{{__('keyworld.Next')}}</button>
